...
export function getLessonsForCourse(courseId: string) {
  const lessonsData: Record<string, Array<{
    ...
    "ai-history-evolution": [
      {
        id: "ai-history-1",
        title: "AIの誕生：1950年代の始まり",
        description: "AIの歴史的起源を理解し、現在のAI技術がどのような基盤の上に築かれているかを把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "ai-history-2",
        title: "深層学習の登場：第三次AIブーム",
        description: "深層学習がどのようにAIを変革したかを理解し、現在のAI技術の基盤を把握します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "ai-history-3",
        title: "AIの未来：医療現場での可能性",
        description: "AIの未来の可能性を理解し、医療現場でのAI活用の方向性を考えます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "ai-history-4",
        title: "日本のAI研究と医療応用",
        description: "日本のAI研究の歴史と特徴を理解し、医療分野での日本の取り組みを把握します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "ai-history-5",
        title: "世界のAI研究と医療応用",
        description: "世界のAI研究の動向と医療応用を理解し、日本の状況と比較します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "ai-history-6",
        title: "AIの歴史から学ぶ：未来への教訓",
        description: "AIの歴史から重要な教訓を学び、現在と未来のAI活用に活かせる視点を獲得します",
        duration: 18,
        slides: 10,
        completed: false,
      },
    ...
    "perplexity-practice": [
      {
        id: "perplexity-1",
        title: "Perplexityとは：AI検索エンジンの基礎",
        description: "Perplexityの特徴と基本的な使い方を理解し、医療情報検索での活用方法を把握します",
        duration: 15,
        slides: 8,
        completed: false,
      },
      {
        id: "perplexity-2",
        title: "医療情報検索でのPerplexity活用",
        description: "Perplexityを医療情報検索で効果的に活用する方法を学びます",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "perplexity-3",
        title: "研究調査でのPerplexity活用",
        description: "Perplexityを研究調査で効果的に活用する方法を学びます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "perplexity-4",
        title: "Perplexityの高度な活用テクニック",
        description: "Perplexityをより効果的に活用する高度なテクニックを習得します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "perplexity-5",
        title: "Perplexityと他のツールの組み合わせ",
        description: "Perplexityを他のAIツールや検索ツールと組み合わせて、より効果的に活用する方法を学びます",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "data-preprocessing-cleaning": [
      {
        id: "data-preprocessing-1",
        title: "データ前処理の重要性",
        description: "データ前処理の重要性を理解し、医療データ分析における前処理の役割を把握します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "data-preprocessing-2",
        title: "欠損値の処理",
        description: "欠損値の種類を理解し、適切な処理方法を選択できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "data-preprocessing-3",
        title: "外れ値の検出と処理",
        description: "外れ値の検出方法と処理方法を学び、医療データにおける外れ値の意味を理解します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "data-preprocessing-4",
        title: "データの正規化と標準化",
        description: "データの正規化と標準化の方法を学び、異なるスケールのデータを統一します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "data-preprocessing-5",
        title: "特徴量エンジニアリング",
        description: "特徴量エンジニアリングの方法を学び、モデルの性能を向上させる特徴量を作成します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "data-preprocessing-6",
        title: "前処理の実践的ワークフロー",
        description: "データ前処理の実践的なワークフローを学び、実際のプロジェクトで適用できる方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "medical-imaging-ai-basics": [
      {
        ...
        title: "医療画像AIの基礎",
        description: "医療画像AIの基本概念を理解し、医療現場での画像診断支援の仕組みを把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        ...
        title: "画像前処理の基礎",
        description: "医療画像の前処理方法を理解し、AIモデルに適した画像を準備できるようになります",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        ...
        description: "CNNの基本構造を理解し、医療画像AIでどのように使用されているかを把握します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "medical-imaging-4",
        title: "転移学習の活用",
        description: "転移学習の概念を理解し、医療画像AIで転移学習を効果的に活用できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "medical-imaging-5",
        title: "モデルの評価と検証",
        description: "医療画像AIモデルの評価方法を理解し、適切な評価指標を選択できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "medical-imaging-6",
        title: "実践的な応用例",
        description: "医療画像AIの実践的な応用例を理解し、実際のプロジェクトで活用できるようになります",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "medical-imaging-7",
        title: "医療画像AIの未来と課題",
        description: "医療画像AIの未来の可能性と課題を理解し、今後の発展方向を把握します",
        duration: 18,
        slides: 10,
        completed: false,
      },
    ...
    "statistics-basics-medicine": [
      {
        id: "statistics-basics-1",
        title: "統計学の基礎：医療研究に必要な統計",
        description: "統計学の基本概念を理解し、医療研究で使用される統計手法の基礎を把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "statistics-basics-2",
        title: "推測統計の基礎：仮説検定とp値",
        description: "推測統計の基本概念を理解し、仮説検定とp値の意味を把握します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "statistics-basics-3",
        title: "信頼区間と効果量",
        description: "信頼区間の意味を理解し、効果量の重要性を把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "statistics-basics-4",
        title: "相関と回帰分析",
        description: "相関と回帰分析の基本を理解し、医療データでの変数間の関係を分析します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "statistics-basics-5",
        title: "感度・特異度・ROC曲線",
        description: "診断テストの評価指標を理解し、ROC曲線とAUCの意味を把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "statistics-basics-6",
        title: "生存分析の基礎",
        description: "生存分析の基本概念を理解し、医療研究での時間イベントデータの分析方法を把握します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "statistics-basics-7",
        title: "メタアナリシスの基礎",
        description: "メタアナリシスの基本概念を理解し、複数の研究結果を統合する方法を把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "statistics-basics-8",
        title: "統計学の実践的な活用",
        description: "統計学を医療研究で実践的に活用できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "model-evaluation-validation": [
      {
        ...
        title: "モデル評価の重要性",
        description: "AIモデルの評価の重要性を理解し、適切な評価方法を選択できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "model-evaluation-2",
        title: "分類モデルの評価指標",
        description: "分類モデルの評価指標を理解し、適切な指標を選択できるようになります",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "model-evaluation-3",
        title: "回帰モデルの評価指標",
        description: "回帰モデルの評価指標を理解し、適切な指標を選択できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "model-evaluation-4",
        title: "過学習の検出と対策",
        description: "過学習の概念を理解し、検出と対策の方法を習得します",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "model-evaluation-5",
        title: "交差検証の実践",
        description: "交差検証の方法を理解し、実践的に活用できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "model-evaluation-6",
        title: "外部検証の重要性",
        description: "外部検証の重要性を理解し、実践的に実施できるようになります",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "model-evaluation-7",
        title: "モデル評価の実践的ワークフロー",
        description: "モデル評価の実践的なワークフローを理解し、実際のプロジェクトで適用できます",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "patient-communication-ai": [
      {
        id: "patient-communication-1",
        title: "AIによる患者コミュニケーション支援の基礎",
        description: "AIを活用した患者コミュニケーション支援の基礎を理解し、実践的に活用できます",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "patient-communication-2",
        title: "診断説明の支援",
        description: "AIを活用して診断結果を患者に分かりやすく説明する方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "patient-communication-3",
        title: "治療法の説明支援",
        description: "AIを活用して治療法を患者に分かりやすく説明する方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "patient-communication-4",
        title: "多言語対応と文化的配慮",
        description: "AIを活用して多言語での患者コミュニケーションを支援する方法を習得します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "patient-communication-5",
        title: "患者コミュニケーション支援の実践",
        description: "AIを活用した患者コミュニケーション支援を実践的に活用できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "ai-bias-fairness": [
      {
        id: "ai-bias-1",
        title: "AIのバイアスとは何か",
        description: "AIのバイアスの概念を理解し、医療AIでのバイアスの重要性を把握します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "ai-bias-2",
        title: "バイアスの検出方法",
        description: "AIシステムのバイアスを検出する方法を理解し、実践的に実施できます",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "ai-bias-3",
        title: "バイアス軽減の手法",
        description: "AIシステムのバイアスを軽減する手法を理解し、実践的に適用できます",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "ai-bias-4",
        title: "医療での公平性の評価",
        description: "医療AIでの公平性を評価する方法を理解し、実践的に実施できます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        ...
        description: "バイアスと公平性に関するベストプラクティスを理解し、実践的に適用できます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        ...
        description: "バイアスと公平性を考慮したAIシステムの開発・評価・運用の実践的ワークフローを理解します",
        duration: 22,
        slides: 14,
        completed: false,
      },
    ...
    "research-protocol-ai": [
      {
        id: "research-protocol-1",
        title: "研究プロトコルとは何か",
        description: "研究プロトコルの基本概念を理解し、AIを活用して研究プロトコルを作成する準備ができます",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "research-protocol-2",
        title: "研究デザインの作成",
        description: "AIを活用して研究デザインを作成する方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "research-protocol-3",
        title: "統計解析計画の作成",
        description: "AIを活用して統計解析計画を作成する方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "research-protocol-4",
        title: "倫理審査申請書の作成",
        description: "AIを活用して倫理審査申請書を作成する方法を習得します",
        duration: 18,
        slides: 10,
        completed: false,
      },
      {
        id: "research-protocol-5",
        title: "研究プロトコル作成の実践",
        description: "AIを活用して研究プロトコルを実践的に作成できるようになります",
        duration: 20,
        slides: 12,
        completed: false,
      },
    ...
    "data-science-fundamentals": [
      {
        id: "data-science-1",
        title: "データサイエンスとは何か",
        description: "データサイエンスの基本概念を理解し、医療データ分析の準備ができます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "data-science-2",
        title: "探索的データ分析（EDA）",
        description: "探索的データ分析の方法を理解し、データの特性を把握できます",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "data-science-3",
        title: "データの可視化",
        description: "データを効果的に可視化する方法を習得します",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "data-science-4",
        title: "データの前処理とクリーニング",
        description: "データの前処理とクリーニングの方法を理解し、実践的に実施できます",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "data-science-5",
        title: "特徴量エンジニアリング",
        description: "特徴量エンジニアリングの方法を理解し、モデルの性能を向上させる特徴量を作成できます",
        duration: 20,
        slides: 12,
        completed: false,
      },
      {
        id: "data-science-6",
        title: "機械学習モデルの基礎",
        description: "機械学習モデルの基本概念を理解し、適切なモデルを選択できます",
        duration: 22,
        slides: 14,
        completed: false,
      },
      {
        id: "data-science-7",
        title: "データサイエンスの実践的ワークフロー",
        description: "データサイエンスの実践的なワークフローを理解し、実際のプロジェクトで適用できます",
        duration: 20,
        slides: 12,
        completed: false,
      },
